...
//                     <Typography variant="h4" className="font-bold font-serif mb-6 text-center">
//                         Customer Form
//                     </Typography>
...
//                         {/* Name & Age */}
//                         <TextField label="Customer Name" name="name" value={customer.name} onChange={handleChange} fullWidth />
//                         <TextField label="Customer Age" name="age" type="number" value={customer.age} onChange={handleChange} fullWidth />

//                         {/* Credit & Transactions */}
//                         <TextField label="Credit Limit" name="credit_limit" type="number" value={customer.credit_limit} onChange={handleChange} fullWidth />
//                         <TextField label="Total Transactions Count" name="total_transactions_count" type="number" value={customer.total_transactions_count} onChange={handleChange} fullWidth />

//                         <TextField label="Total Transaction Amount" name="total_transaction_amount" type="number" value={customer.total_transaction_amount} onChange={handleChange} fullWidth />
//                         <TextField label="Inactive Months (Last 12 Months)" name="inactive_months" type="number" value={customer.inactive_months} onChange={handleChange} fullWidth />

//                         <TextField label="Transaction Count Change (Q4-Q1)" name="transaction_count_change" type="number" value={customer.transaction_count_change} onChange={handleChange} fullWidth />
//                         <TextField label="Total Products Used" name="total_products_used" type="number" value={customer.total_products_used} onChange={handleChange} fullWidth />

//                         <TextField label="Average Credit Utilization" name="credit_utilization" type="number" value={customer.credit_utilization} onChange={handleChange} fullWidth />
//                         <TextField label="Customer Contacts (Last 12 Months)" name="customer_contacts" type="number" value={customer.customer_contacts} onChange={handleChange} fullWidth />

//                         <TextField label="Transaction Amount Change (Q4-Q1)" name="transaction_amount_change" type="number" value={customer.transaction_amount_change} onChange={handleChange} fullWidth />
//                         <TextField label="Months as Customer" name="months_as_customer" type="number" value={customer.months_as_customer} onChange={handleChange} fullWidth />

//                         {/* Joining Date */}
//                         <TextField  name="joining_date" type="date" value={customer.joining_date} onChange={handleChange} fullWidth />

//                         {/* Education Dropdown */}
//                         <TextField select label="Education Level" name="education" value={customer.education} onChange={handleChange} fullWidth>
...
//                         {/* Income Dropdown */}
//                         <TextField select label="Income Level" name="income" value={customer.income} onChange={handleChange} fullWidth>
