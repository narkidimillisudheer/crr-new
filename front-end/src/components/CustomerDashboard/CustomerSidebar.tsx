...
import { Home, Notifications, Assessment, Logout } from "@mui/icons-material";
    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg flex flex-col p-5">
            ...
            <nav className="flex flex-col justify-start gap-4">
                <Button startIcon={<Home />} onClick={() => handleNavigation("/customer-dashboard")} fullWidth className="justify-start text-black">
                    Dashboard
                </Button>
